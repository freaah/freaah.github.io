...
import TextInput from "../../TextInput"; // plasmic-import: OquQxNPlwArq/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 7QNCWTP-3pH2/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: jHJkxpVOWWNk/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__wfE7, {
          [sty.freeBoxiconEnd__wfE7HYwGm]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__wfE7ThsPi]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__wfE7OL9Gi]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__cekLj, {
            [sty.freeBoxiconStart__cekLjthsPi]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__cekLJoL9Gi]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___8Kx7Q)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__nk94K, {
            [sty.freeBoxiconEnd__nk94KhYwGm]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__nk94KThsPi]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___7H7Ef)}
                role={"img"}
              />
            ),
