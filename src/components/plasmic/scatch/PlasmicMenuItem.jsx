...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: SPPaFCfdP_1a/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__eduow)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__wmi5)}>
            <div
              className={classNames(
                projectcss.all,
