...
function BaseCheckboxGroup(props) {
  ...
  return /* @__PURE__ */ React.createElement(PlasmicCheckboxGroupContext.Provider, { value: __spreadProps(__spreadValues({}, rest), { idManager }) }, /* @__PURE__ */ React.createElement(CheckboxGroup, __spreadProps(__spreadValues({}, rest), { style: COMMON_STYLES }), ({ isDisabled, isReadOnly }) => withObservedValues(
    children,
    {
      disabled: isDisabled,
      readonly: isReadOnly
